...
| valid_time       | integer   | Y    | Unit: Minutes (Integer value from 10 to 1440) <br/> The valid time for this order. If the valid time is expired, the payment will not be accepted.            |
