...
description: 'Initiate a payout request to disburse funds from a wallet address.'
---
...
| callback_url   | string         | No      | Callback URL, If funds are successfully received, refer to [Payout notify](/api-reference/callback/payout) section for callback details.     |
