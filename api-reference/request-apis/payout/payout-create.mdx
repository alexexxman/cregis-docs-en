...
| callback_url   | string         | Yes      | Callback URL, If funds are successfully received, refer to [Payout notify](/api-reference/callback/payout) section for callback details.     |
