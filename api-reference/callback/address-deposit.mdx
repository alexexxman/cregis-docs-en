...
_The callback URL is provided in request body by the request initiator. For more details, see the `callback_url` parameter in the [Create Address API](/api-reference/request-apis/address-generate)._
