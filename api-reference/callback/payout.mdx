...
_The callback URL is provided in request body by the request initiator. For more details, see the `callback_url` parameter in the [Create Payout API](/api-reference/request-apis/payout-create)._
