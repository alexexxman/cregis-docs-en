---
title: 'Wallet payout notify'
description: 'Receive notifications for wallet payout information.'
---

## Callback API

_The callback URL is provided in request body by the request initiator. For more details, see the `callback_url` parameter in the [Create payout order](/api-reference/request-apis/payout/payout-create)._
