---
title: 'Callback > Payment'
description: 'The notification for payment result.'
---

## Callback API

Notify the caller when the order status changes using the provided `callback_url`, details for [Payment->Create](/api-reference/request-apis/payment-create) `callback_url` param
