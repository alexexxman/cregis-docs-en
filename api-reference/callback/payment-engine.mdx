...
| order_currency       | string  | Order currency code, i.e. ISO 4217 currency code, such as CNY, HKD, defined by the merchant, [Order currency List](/api-reference/request-apis/payment/payment-order-currency)        |
